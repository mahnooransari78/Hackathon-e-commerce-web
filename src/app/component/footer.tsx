    ...
    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <ul className="list-none mb-10 leading-10 text-gray-400">
          ...
          <li>
            <a className="text-gray-400 hover:text-gray-800 ml-6">Cameras & Photography</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800 ml-6">Smart Phones & Tablets</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800 ml-6">Video Games & Consoles</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800 ml-6">Waterproof Headphones</a>
          </li>
        </ul>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <ul className="list-none mb-10 leading-10">
          <li>
            <a className="text-gray-400 hover:text-gray-800">My Account</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Discount</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Returns</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Orders History</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Order Tracking</a>
          </li>
        </ul>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <ul className="list-none mb-10 leading-10">
          ...
          <li>
            <a className="text-gray-400 hover:text-gray-800">Browse the Shop</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Category</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Pre-Built Pages</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">Visual Composer Elements</a>
          </li>
          <li>
            <a className="text-gray-400 hover:text-gray-800">WooCommerce Pages</a>
          </li>
        </ul>
      </div>
