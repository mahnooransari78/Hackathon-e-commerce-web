...
const Tcards = () => {
    ...
    return(
        <section className='mx-auto mt-10 flex flex-wrap gap-4 justify-center'>
  <div className='bg-[#FFF6FB] w-full md:w-[380px] h-[270px] p-2 transition hover:-translate-y-2 shadow-lg flex flex-col items-center'>
  ...
  <div className='bg-[#EEEFFB] w-full md:w-[380px] h-[270px] p-2 transition hover:-translate-y-2 shadow-lg flex flex-col items-center'>
    <p className='text-2xl font-semibold text-[#151875] text-center'>
      {"23% off in all products"}
    </p>
  ...
  <div className='w-full md:w-[380px] p-2 grid grid-cols-1 gap-4'>
    {[seat1, seat2, seat3].map((item, index) => (
      <div 
        key={index}
        className='hover:shadow-lg flex gap-3 items-center'
      >
        ...
        <div>
          ...
          <p className='w-[37px] line-through text-[#151875]'>
            {"$32.00"}
          </p>
        </div>
      </div>
